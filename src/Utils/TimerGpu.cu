...
void TimerGpu::print(const std::string& header,
...
void TimerGpu::writeToFile(const std::string& path, const std::string& header,
                           const std::string& footer) const {
  /*
...
double TimerGpu::calculateTotal(std::vector<std::string> ignoreNames) const {
  double sum = 0.0;
